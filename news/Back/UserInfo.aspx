            ...
            <form class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_username" name="username" required="" lay-verify="nikename" value="<%=(Session["AdminInfo"] as Model.User).nickName %>" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
            ...
            function () {
                ...
                form.on('submit(add)',
                    function (data) {
                        ...
                        //发异步，把数据提交给php
                        $.ajax({
                            url: "/Back/EditUserInfo.ashx", //请求后端路径
                            type: "post",
                            data: {
                                userId: <%=(Session["AdminInfo"] as Model.User).id %>,
                                pass: $("#L_pass").val(),
